      ...
      <div class="container-fluid">
            <div class="row ">
                   ...
                   <label for="" class="text-uppercase "><strong></strong></label><br><p class="text-info"
                     class="text-uppercase small"><b>QR BOOKING</b> </p>
                  </div>
            </div>
            <div class="row ">
                  <div class="col-xl-3 col-lg-3 col-mb-4 col-sm-6">
                        <a href=".html">
                              <div class="container vbox text-light pd mb-3 ml-auto">
                                <p class="text-center"> JOURNEY BY QR <img src="image/qr.png" height="70px" width="70px" alt=""></p> 
            ...
            <div class="row ">
                <div class="col-xl-3 col-lg-3 col-mb-4 col-sm-6">
                         <a href=".html">
                                ...
                                <p class="text-center"> PLATFORM BY QR<img src="image/qr2.png" height="70px" width="70px" alt=""></p>
                                </div>
                         </a>
                  </div>
            </div> 
