        ...
        <div class="row">
            <div class="col-md-12 text-center mb-3">
                <label for="" class="text-uppercase "><strong></strong></label><br><p class="text-info"
                     class="text-uppercase small"> <b>CHANGE PASSWORD</b></p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-12">
                <form action="#.php" method="post"> 
                    <div      class="container   text-dark pd mb-2">
                ...
                <div      class="container   text-dark pd mb-2">
                <bttton type="submit" class="btn btn-success btn-block">CHANGE PASSWORD</bttton>
                </div>
              </form>
            </div> 
      </div>    
