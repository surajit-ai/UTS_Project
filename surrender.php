...
<body style="background:url(image/PicsArt_02-12-01.55.12.jpg);background-size: cover;">
    <nav class="navbar navbar-expand-sm navbar-light bg-white">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item"><a href="wallet.php" class="nav-link"><b>HOME</b></a></li>
        </ul>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-center mb-3">
                <label for="" class="text-uppercase "><strong></strong></label><br><p class="text-info"
                     class="text-uppercase small"> <b>SURRENDER WALLET</b></p>
            </div>
         </div>
         ...
         <div class="row">
            <div class="col-md-12">
                <a href="#">
                    <div class="container mbox  text-light pd mb-3">
                    </div>
                </a>
            </div>
      </div>
            ...
            <div class="col-md-12">
                <a href=".html">
                    <div class="container dbox  text-light pd mb-3">
                        <p class="text-center"> SURRENDER WALLET</p>
                    </div>
                </a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                    <div class="container   text-danger pd mb-3">
                        <p class="text-center"> <b>No ticket will be booked using r-wallet once surrendered.</b></p>
                    </div>
                </a>
            </div>
        </div>
